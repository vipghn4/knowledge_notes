...
**Pervasive systems**. The separation of users and system components is much more blurred, compared to computing and information systems

$\to$ There is no single dedicated interface, e.g. screen-keyboard combination
* *Interfaces to pervasive systems*.
