...
* *Objective 1*. We are used to thinking of sizing queues so as to prevent them from overflowing and losing packets
...
* *Objective 2*. When TCP flows pass through the router, they do not underflow and lose throughput
